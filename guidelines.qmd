...
- general description
  ...
  - if only data from the RISM entry were used, write “catalogued according to RISM entry”
...
- *creation*
  ...
  - place of composition; use brackets to indicate assumed place, e.g. “[Eisenstadt]”
