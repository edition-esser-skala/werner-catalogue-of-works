...
- H-Bn: [Ms. mus. IV. 2.166](rism.online/sources/1001303905) comprises six fugues (“6. aus ſeinen Meſsen gezohene Fugen für die 4. Singſtimmen mit der Orgel für Komponisten”). This source is mentioned in the catalogue of Joseph Haydn's artistic effects [@Sauer1809, fol. 13v, no. 534]. No. 1 is *Kyrie eielson* from the *Missa Annuntio vobis gaudium* [WerW B.5](groups/masses.html#work-B.5), no. 6 is *Cum Sancto Spiritu* from the *Missa primitiva* [WerW B.35](groups/masses.html#work-B.35). No. 2–5 cannot yet be assigned:
