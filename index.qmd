...
ARKs are resolved by `https://edition.esser-skala.at` via several rewriting rules in `.htaccess`. The resolver also supports the following features:
...
- The inflection `?info` yields a brief metadata record following the [Dublin Kernel](https://www.dublincore.org/groups/kernel/spec/) specification.<br/>
