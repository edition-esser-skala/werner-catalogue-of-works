...
ARKs are resolved by `https://ark.esser-skala.at` via a [minimal ARK resolver](https://github.com/edition-esser-skala/minimal-ark-resolver). (They are also forwarded to the rseolver from this sites's base URL via its `.htaccess` file.) The resolver also supports the following features:

- The object variant `.mei` directly resolves to the metadata in MEI format.<br/>
Example: [ark:68748/gw1b1.mei](https://ark.esser-skala.at/ark:68748/gw1b1.mei)
...
Examples: [ark:68748/gw1b1?info](https://ark.esser-skala.at/ark:68748/gw1b1?info) and [ark:68748/gw1b1.mei?info](https://ark.esser-skala.at/ark:68748/gw1b1.mei?info)
